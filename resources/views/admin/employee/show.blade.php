                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="phone" id="phone"
                                            ...
                                            class="form-control @error('phone') is-invalid @enderror" required readonly>
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file"
                                                ...
                                                id="picture" name="picture" accept=".jpeg,.jpg,.png" disabled>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[biometricId]" id="biometricId" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[educationDetails]" id="educationDetails" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[salary]" id="salary" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[emergencyContactName]"
                                            id="emergencyContactName" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[emergencyContactNumber]"
                                            id="emergencyContactNumber" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="vehiclePlateNumber" class="form-label">Vehicle plate
                                            number</label>
                                        <input type="text" name="details[vehiclePlateNumber]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[bloodGroup]" id="bloodGroup" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="allergyOrDisease" class="form-label">Any allergy or
                                            disease</label>
                                        <input type="text" name="details[allergyOrDisease]" id="allergyOrDisease" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[shiftTimings]" id="shiftTimings" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[experienceDetails]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[designation]" id="designation" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[homeAddress]" id="homeAddress" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[maritalStatus]" id="maritalStatus" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="details[workEmail]" id="workEmail" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[workEmailPassword]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="details[companyEmail]" id="companyEmail" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[companyEmailPassword]"
                                            id="companyEmailPassword" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[pcPassword]" id="pcPassword" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[pcDetails]" id="pcDetails" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="anyPaidPlatform" class="form-label">Any paid platform in
                                            use</label>
                                        <input type="text" name="details[anyPaidPlatform]" id="anyPaidPlatform" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[idAndPasswordOfAnyPaidPlatforms]"
                                            id="idAndPasswordOfAnyPaidPlatforms" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="peripheralDevices" class="form-label">Any other peripheral device
                                            in use</label>
                                        <input type="text" name="details[peripheralDevices]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details[jobType]" id="jobType" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="details[joiningDate]" id="joiningDate" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="firstSalaryIncrement" class="form-label">First Salary increment
                                            (Amount & Month)</label>
                                        <input type="text" name="details[firstSalaryIncrement]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="secondSalaryIncrement" class="form-label">Second Salary increment
                                            (Amount & Month)</label>
                                        <input type="text" name="details[secondSalaryIncrement]" readonly
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group">
                                        <label for="thirdSalaryIncrement" class="form-label">Third Salary increment
                                            (Amount & Month)</label>
                                        <input type="text" name="details[thirdSalaryIncrement]" readonly
