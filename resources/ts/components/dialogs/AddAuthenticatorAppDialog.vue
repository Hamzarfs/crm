...
<template>
    <VDialog max-width="900" :model-value="props.isDialogVisible"
        @update:model-value="(val) => $emit('update:isDialogVisible', val)">
        <VCard class="pa-sm-11 pa-3">
            <!-- 👉 dialog close btn -->
            <DialogCloseBtn variant="text" size="default" @click="resetAuthCode" />
            ...
            <VCardText class="pt-5">
                ...
                <VAlert color="warning" variant="tonal" class="my-4">
                    <template #title>
                ...
                <VForm @submit.prevent="() => { }">
                    <VTextField v-model="authCode" name="auth-code" label="Enter Authentication Code"
                        placeholder="123 456" class="mb-8" />

                    <div class="d-flex justify-end flex-wrap gap-4">
                        <VBtn color="secondary" variant="outlined" @click="resetAuthCode">
                            Cancel
                        </VBtn>
