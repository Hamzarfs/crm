...
<template>
    ...
    <div class="d-flex align-center justify-center mx-auto pt-sm-9 pb-sm-8 py-4">
        ...
        <div class="position-relative">
            <div class="pricing-save-chip position-absolute d-sm-block d-none">
                <VIcon start icon="ri-corner-left-down-fill" size="24" class="text-disabled flip-in-rtl mt-1" />
                <VChip size="small" color="primary" class="mt-n2">
                    Save up to 10%
                </VChip>
            </div>
    ...
    <VRow>
        <VCol v-for="plan in pricingPlans" :key="plan.logo" v-bind="props">
            <!-- 👉  Card -->
            <VCard flat border :class="plan.isPopular ? 'border-primary border-opacity-100' : ''">
                ...
                <VCardText class="text-center">
                    <VImg :height="120" :src="plan.logo" class="mx-auto mb-5" />
                    ...
                    <div>
                        <div class="d-flex justify-center align-center">
                            ...
                            <h1 class="text-h1 font-weight-medium text-primary">
                                {{ annualMonthlyPlanPriceToggler ? Math.floor(Number(plan.yearlyPrice) / 12) :
                                    plan.monthlyPrice }}
                            </h1>
                        ...
                        <!-- 👉 Annual Price -->
                        <div v-show="annualMonthlyPlanPriceToggler" class="text-caption">
                ...
                <VCardText class="pt-2">
                    <VList class="card-list pb-5">
                        <VListItem v-for="feature in plan.features" :key="feature">
                            ...
                            <VListItemTitle class="text-body-1 d-flex align-center">
                                <VIcon :size="14" icon="ri-circle-line" class="me-2" />
                    ...
                    <!-- 👉 Plan actions -->
                    <VBtn :active="false" block :color="plan.current ? 'success' : 'primary'"
                        :variant="plan.isPopular ? 'elevated' : 'outlined'" :to="{ name: 'front-pages-payment' }">
