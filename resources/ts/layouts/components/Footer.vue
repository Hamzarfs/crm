<template>
    <div class="h-100 d-flex align-center justify-space-between text-medium-emphasis">
        ...
        <span class="d-flex align-center">
            ...
            By <a href="https://redfeathersolutions.com/" target="_blank" rel="noopener noreferrer"
                class="text-primary ms-1">Red Feather Technologies</a>
        </span>
        ...
        <!-- <span class="d-md-flex gap-x-4 text-primary d-none">
            ...
            <a href="https://demos.themeselection.com/materio-vuetify-vuejs-admin-template/documentation/guide/laravel-integration/folder-structure.html"
