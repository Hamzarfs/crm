            ...
            <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
              ...
              padding-inline: 0.625rem;"
                    ...
                    <div class="align-center justify-space-between"
                        ...
                        <div>
                            <VSwitch id="customizer-semi-dark" v-model="configStore.isVerticalNavSemiDark"
                                class="ms-2" />
                        </div>
                    </div>
                </CustomizerSection>
                ...
                <CustomizerSection title="Layout">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <CustomRadiosWithImage :key="currentLayout" v-model:selected-radio="currentLayout"
                            :radio-content="layouts" :grid-column="{ cols: '4' }">
                            <template #label="item">
                                <span class="text-sm text-medium-emphasis">{{ item.label }}</span>
                            </template>
                        </CustomRadiosWithImage>
                    ...
                    <!-- <div class="d-flex flex-column gap-3">
                        ...
                        <CustomRadiosWithImage :key="currentDir" v-model:selected-radio="currentDir"
                            :radio-content="direction" :grid-column="{ cols: '4' }">
                            <template #label="item">
                                <span class="text-sm text-medium-emphasis">{{ item?.label }}</span>
                            </template>
                        </CustomRadiosWithImage>
