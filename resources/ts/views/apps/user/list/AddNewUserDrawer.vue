                ...
                <VCardText>
                    ...
                    <VForm ref="refForm" v-model="isFormValid" @submit.prevent="onSubmit">
                        <VRow>
                            ...
                            <!-- 👉 Country -->
                            <VCol cols="12">
                                <VSelect v-model="country" label="Select Country" placeholder="Select Country"
                            ...
                            <!-- 👉 Plan -->
                            <VCol cols="12">
                                <VSelect v-model="plan" label="Select Plan" placeholder="Select Plan"
                                    :rules="[requiredValidator]" :items="['Basic', 'Company', 'Enterprise', 'Team']" />
                            </VCol>
