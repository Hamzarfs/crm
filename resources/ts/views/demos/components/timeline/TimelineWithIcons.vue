...
<template>
    <div class="my-6">
        ...
        <VTimeline align="start" line-inset="20" truncate-line="start" justify="center"
            :density="$vuetify.display.smAndDown ? 'compact' : 'default'" class="mt-12">
                ...
                <template #icon>
                    <div class="v-timeline-avatar-wrapper rounded-circle">
                        <VAvatar size="32" color="error" variant="tonal">
                            <VIcon icon="ri-file-word-line" size="20" />
                        </VAvatar>
                    </div>
                </template>
                <!-- 👉 Header -->
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        ...
                        <p class="app-timeline-text mb-3">
                            he process of recording the key project details and producing the documents that are
                            required to implement
                            it successfully. Simply put, it's an umbrella term which includes all the documents created
                            over the course
                            of the project.
                        </p>
                ...
                <template #icon>
                    <div class="v-timeline-avatar-wrapper rounded-circle">
                        <VAvatar size="32" color="success" variant="tonal">
                            <VIcon size="20" icon="ri-image-line" />
                        </VAvatar>
                    </div>
                </template>
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        <p class="mb-3">
                            In the Select Image for Project dialog box, choose one of the following: Under the Upload
                            New Image
                            section
                        </p>
                ...
                <template #icon>
                    <div class="v-timeline-avatar-wrapper rounded-circle">
                        <VAvatar size="32" color="warning" variant="tonal">
                            <VIcon size="20" icon="ri-star-smile-line" />
                        </VAvatar>
                    </div>
                </template>
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        <div>
                            ...
                            <div>
                                I wish I could select more than one main reason for rating this. I love how they
                                constantly work on
                                to make the template better. I am so thankful for this. Also, in the past, they had
                                responded well
                                to my tickets. Thank you for this great theme, for such an amazing support, for the
                                better updates.
                                I wish I could rate this for so many times. I highly recommend this template!
                            </div>
                        </div>
                    </VCardText>
                </VCard>
                ...
                <template #icon>
                    <div class="v-timeline-avatar-wrapper rounded-circle">
                        <VAvatar size="32" color="info" variant="tonal">
                            <VIcon size="20" icon="ri-pie-chart-line" />
                        </VAvatar>
                    </div>
                </template>
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        <div class="mb-3">
                            <div class="d-flex align-center">
                                ...
                                <VIcon size="30" icon="ri-arrow-up-s-fill" color="success" />
                        ...
                        <VList class="card-list">
                            <VListItem v-for="earning in earnings" :key="earning.title">
                                <template #prepend>
                                    <VAvatar variant="tonal" rounded :image="earning.avatar" />
                                </template>
                                ...
                                <template #append>
                                    <div>
                                        ...
                                        <VProgressLinear :color="earning.progress" rounded rounded-bar
                                            model-value="80" />
                                    </div>
                                </template>
                            </VListItem>
            ...
            <VTimelineItem fill-dot size="small">
                <template #icon>
                    <div class="v-timeline-avatar-wrapper rounded-circle">
                        <VAvatar size="32" color="primary" variant="tonal">
                            <VIcon size="18" icon="ri-folder-3-line" />
                        </VAvatar>
                    </div>
                </template>
                <template #opposite>
                ...
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        <p class="mb-3">
                            The structure and process are defined in the project organization considering the attainment
                            of the
                            corporate objectives and therefore also project objectives. The components of the project
                            process are
                        </p>
                        ...
                        <div class="d-flex gap-4 align-center">
                            <div class="flex-grow-1">
                                <VProgressLinear :model-value="34" rounded rounded-bar height="6" />
                            </div>
                            <div>34%</div>
                        </div>
                    </VCardText>
