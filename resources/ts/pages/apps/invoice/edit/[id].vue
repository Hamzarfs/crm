...
<template>
    <VRow v-if="invoiceData && invoiceData?.invoice">
        <!-- 👉 InvoiceEditable -->
        <VCol cols="12" md="9">
            <InvoiceEditable v-if="invoiceData?.invoice" :data="invoiceData" @push="addProduct"
        ...
        <VCol cols="12" md="3">
            <VCard class="mb-8">
                <VCardText>
                    ...
                    <VBtn block prepend-icon="ri-send-plane-line" class="mb-4" @click="isSendSidebarActive = true">
                        Send Invoice
                    </VBtn>

                    <div class="d-flex flex-wrap gap-4">
                        <!-- 👉  Preview button -->
                        <VBtn color="secondary" variant="outlined" class="flex-grow-1"
                    ...
                    <VBtn block color="success" prepend-icon="ri-money-dollar-circle-line"
            ...
            <!-- 👉 Accept payment via  -->
            <VSelect v-model="selectedPaymentMethod" :items="paymentMethods" label="Accept Payment Via" class="mb-6" />
