...
export const emailsMeta = {
    inbox: emails.filter(email => !email.isDeleted && !email.isRead && email.folder === 'inbox').length,
    draft: emails.filter(email => !email.isDeleted && email.folder === 'draft').length,
    spam: emails.filter(email => !email.isDeleted && !email.isRead && email.folder === 'spam').length,
    star: emails.filter(email => !email.isDeleted && email.isStarred).length,
}
