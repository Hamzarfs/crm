import{u as m,S as f,P as k,U as b,E as v}from"./index-CKaYAiOH.js";import{T as C}from"./index-w_tptuY5.js";import{V as a}from"./VChip-D3GIz1VX.js";import{V as y}from"./VDivider-CiGpRMeQ.js";import{d as p,o as c,c as s,n as o,b as t,f as r,p as n,x as V,r as x,aG as A,g as B}from"./main-DoQFmMsa.js";import{_ as w}from"./AppCardCode.vue_vue_type_style_index_0_lang-CmwJwIsY.js";import{_ as E}from"./TiptapEditor.vue_vue_type_style_index_1_lang-BZRfywlN.js";import{a as g,V as H}from"./VRow-CBIZXy0V.js";import"./VSlideGroup-DZ8i23BH.js";import"./VAvatar-A7ztkq2k.js";import"./VImg-BvvxBpKO.js";import"./vue3-perfect-scrollbar-Dah25qMm.js";import"./VCard-CvMXks-w.js";/* empty css              */const $={class:"border pa-2 rounded"},I={key:0,class:"d-flex flex-wrap gap-x-4 gap-y-2 mb-2"},_=p({__name:"DemoEditorCustomEditor",setup(u){const e=m({content:`
        <h2>
          Hi there,
        </h2>
        <p>
...
`);return(h,i)=>{const l=E;return c(),s("div",null,[t(l,{modelValue:o(e),"onUpdate:modelValue":i[0]||(i[0]=d=>A(e)?e.value=d:null),class:"border rounded"},null,8,["modelValue"])])}}}),q={ts:`<script setup lang="ts">
...
`},F=p({__name:"editors",setup(u){return(e,h)=>{const i=T,l=w,d=_;return c(),B(H,null,{default:r(()=>[t(g,{cols:"12"},{default:r(()=>[t(l,{title:"Basic Editor",code:q},{default:r(()=>[t(i)]),_:1},8,["code"])]),_:1}),t(g,{cols:"12"},{default:r(()=>[t(l,{title:"Custom Editor",code:S},{default:r(()=>[t(d)]),_:1},8,["code"])]),_:1})]),_:1})}}});export{F as default};
